  ...
  return (
    <div className={styles.contactPage}>
          ...
          <div className={styles.contactGrid}>
            <div className={`${styles.contactInfo} fade-in delay-100`}>
              ...
              <p className={styles.infoDesc}>
                Whether you're looking to host a private event, share feedback, or just say ciao, 
              ...
              <div className={styles.infoBlock}>
                <h3>Contact</h3>
                <p>
                  <a href="tel:+15551234567" className={styles.contactLink}>+1 (555) 123-4567</a><br/>
            ...
            <div className={`${styles.contactFormWrapper} fade-in delay-200`}>
              ...
              <form className={styles.contactForm}>
                ...
                <div className="form-group">
                  ...
                  <input type="email" id="email" className="form-control" required placeholder="your.email@example.com" />
                </div>
                <div className="form-group">
                  <label htmlFor="subject" className="form-label">Subject</label>
                  <input type="text" id="subject" className="form-control" required placeholder="How can we help?" />
                </div>
                <div className="form-group">
                  <label htmlFor="message" className="form-label">Message</label>
                  <textarea id="message" className="form-control" rows={5} required placeholder="Your message here..."></textarea>
                </div>
      ...
      <section className={styles.mapSection}>
        {/* Placeholder for embedded Google Maps */}
        <div className={styles.mapPlaceholder}>
          <div className={styles.mapOverlay}>
            <h3>Casa Bella Ristorante</h3>
            <p>123 Bella Ave, Cityville, CA</p>
            <a href="#" className="btn btn-secondary" style={{borderColor: 'white', color: 'white', marginTop: '1rem'}}>Get Directions</a>
          </div>
        </div>
      </section>
    </div>
